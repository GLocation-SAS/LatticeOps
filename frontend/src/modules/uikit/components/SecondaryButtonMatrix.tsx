    ...
    <div className="space-y-32 mt-16 pb-32 max-w-7xl px-8">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <Badge className="bg-secondary-500/10 text-secondary-600 border-none font-heading font-bold px-4 py-1.5 rounded-xl text-[11px]">
        ...
        <div className="space-y-2">
          ...
          <h2 className="text-5xl font-heading font-bold tracking-tight text-neutral-900 italic">
            ...
            Secondary <span className="text-secondary-500">Button</span>
          </h2>
          <p className="text-neutral-500 max-w-3xl text-xl leading-relaxed font-sans">
            
            Acción de apoyo. Complementa al botón primario en interfaces con
            múltiples acciones. Diseñado para ofrecer una alternativa visual
            clara sin competir por el foco principal.
          </p>
        </div>
      </div>
              ...
              <div className="grid grid-cols-[200px_repeat(4,1fr)] border-b border-neutral-100 dark:border-neutral-300 bg-neutral-50/50 dark:bg-neutral-100/80">
                ...
                {SIZES.map((s) => (
                  <div key={s.key} className="px-6 py-6 text-left">
                    ...
                    <div className="text-[10px] text-secondary-500 font-bold mt-1 ">
                      {s.px}
                    </div>
                  </div>
                ))}
      ...
      <SpecFooter
        specs={[
          {
            label: "Construcción",
            text: "Utiliza un fondo neutral suavizado con bordes de 1.5px. El contraste se mantiene optimizado para asegurar la accesibilidad en fondos claros y oscuros.",
          },

          {
            label: "Interacción",
            text: "Respuesta táctil mediante cambios sutiles en la opacidad del fondo y elevación de sombra, siguiendo el sistema de micro-animaciones global.",
          },
        ]}
        compositionText="El botón secundario actúa como el balance perfecto en layouts densos. Su diseño 'outlined' permite que la información circundante respire, mientras mantiene una zona interactiva clara y definida."
      />
    </div>
  );
}
