    ...
    <div className="space-y-32 mt-16 pb-32 max-w-7xl px-8">
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-start gap-3">
          ...
          <Badge className="bg-neutral-500/10 text-neutral-600 border-none font-heading font-bold px-4 py-1.5 rounded-xl text-[11px]">
        ...
        <div className="space-y-2">
          ...
          <h2 className="text-5xl font-heading font-bold tracking-tight text-neutral-900 italic">
            ...
            Neutral <span className="text-neutral-500">Button</span>
          </h2>
          <p className="text-neutral-500 max-w-3xl text-xl leading-relaxed font-sans">
            
            Para acciones discretas o de bajo impacto visual. Ideal en contextos
            donde el botón no debe competir con otros elementos de mayor
            jerarquía, manteniendo una estética limpia y profesional.
          </p>
        </div>
      </div>
      ...
      <SpecFooter
        specs={[
          {
            label: "Composición",
            text: "Utiliza tonos de la escala de grises (Neutral-50 a Neutral-900) para minimizar la carga cognitiva del usuario en interfaces densas.",
          },

          {
            label: "Visual Echo",
            text: "Respuesta visual mediante transiciones suaves de fondo, manteniendo la forma Pill System y los bordes de 1.5px estándar del sistema.",
          },
        ]}
        compositionText="El botón neutro es la herramienta fundamental para acciones secundarias o terciarias. Su diseño permite que se integre perfectamente en barras de herramientas, pies de página o modales sin distraer de la acción principal."
      />
    </div>
  );
}
